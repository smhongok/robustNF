...
if __name__=="__main__":
    ...
    parser.add_argument('--name', type=str, default='4X')
    parser.add_argument('--gt_dir', type=str, default='~/data/DIV2K-va/')
    parser.add_argument('--srs_dir', type=str, default='./experiments/4X_17/')
    ...
    check = list(range(n_imgs))
    for img_idx in check:
    ...
    for img_idx in range(len(check)):
