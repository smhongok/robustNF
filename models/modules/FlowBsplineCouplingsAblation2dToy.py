...
class CondBsplineSeparatedAndCond2dToy(nn.Module):
    def __init__(self, in_channels, opt, std_mode=True):
        ...
        self.fBspline = self.F(in_channels=self.channels_for_nn + self.in_channels_rrdb,
                              out_channels=self.channels_for_co * (NUM_freeT+NUM_freeA), # 10 is DOF for knots + widths
